...
def acasx(cfg: ACASXConfig) -> None:
    ...
    async def startup_event() -> None:  # noqa: RUF029
        ...
        asyncio.create_task(acasx_runner.run())  # noqa: RUF006
    ...
    @app.get("/intruders")
    async def get_intruders() -> dict[str, ExtendedIntruder | float]:
    ...
    async def root() -> RootInfo:
        ...
        Returns:
            RootInfo: The information about both CAS system aka the full
                ACAS X system.
        """
        return {
