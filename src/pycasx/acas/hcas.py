...
class HCASMixin:
    ...
    def advise_hcas(self: ACASXProtocol, intruder: Intruder) -> HCASAdvisories:
        ...
        # an active state.
        if tau < 0.0 or tau > 60.0:  # noqa: PLR2004
        ...
        # lower than 0 are for internal purposes only and are not
        # defined for the underlying neural networks.
        ...
        return HCASAdvisories(int(outputs.argmax()))
