...
ModelDict: TypeAlias = dict[str, NNet] | dict[str, ModelProto] | dict[str, GraphModule]
...
def check_for_loss_of_separation(  # noqa: PLR0914
    ac_1: Aircraft,
    ac_2: Aircraft,
...
class Intruder:
    ...
    def triggers_nmac(self) -> bool:
        """Whether the intruder triggers a NMAC for the ownship.
...
class ExtendedIntruder:
    """An extended intruder representation relying on advisory data.
