...
def create_scenario(cfg: ScenarioConfig) -> None:
    ...
    if n_intruders > 0:
        scenario_file = Path(ai_folder, f"{uuid_}_scenario.xml")
        ...
        scenario_cfg = create_ai_scenario_xml(cfg, uuid_, flightplan_files)
