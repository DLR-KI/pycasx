...
"""Calculate the CPA given the time to CPA."""
...
def calculate_cpa(
    ...
    """Calculate the CPA given the initial condition.
    ...
    Returns:
        GeographicCoordinates | tuple[float, float]: The closest point
            of approach as a GeographicCoordinates object if
            `return_tuple` is false, otherwise as a tuple of latitude
            and longitude in the specified order.
    """
    dist = (
